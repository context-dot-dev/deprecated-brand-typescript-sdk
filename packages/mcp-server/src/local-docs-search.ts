...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: ['domain: string;', 'maxAgeMs?: number;', 'tags?: string[];', 'timeoutMS?: number;'],
    response:
